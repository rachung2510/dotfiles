...
WSICONMAP = {
	...
	"window_title=win.* on QEMU/KVM": "windows",
	...
	"window_class=Postman": "postman",
	"window_class=Shotcut": "video",
	"window_class=Spotify": "music",
	"window_class=TelegramDesktop": "telegram",
	"window_class=teams-for-linux": "teams",
	"window_class=[tT]hunderbird": "email",
	"window_class=Virt-manager": "virtualbox",

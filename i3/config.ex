...
bindsym Mod1+Tab exec --no-startup-id ~/.config/i3/scripts/focus-next-visible.py
bindsym Mod1+Shift+Tab exec --no-startup-id ~/.config/i3/scripts/focus-next-visible.py reverse
...
## App shortcuts
bindsym $mod+c exec microsoft-edge-stable

...
i3bar used when system tray needs to be accessed.
<img src="https://github.com/rachung2510/dotfiles/blob/master/screenshots/i3bar.png?raw=true" alt="Home Page" width="800" />
